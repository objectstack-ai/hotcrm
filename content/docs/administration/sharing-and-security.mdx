...
A *Sales Director* automatically sees every opportunity owned by anyone below them. They do not see Service or Marketing records (those are siblings, not children). To split a region into multiple teams (e.g. *Sales Manager — East* and *Sales Manager — West*), clone the **Sales Manager** node.
