...
- **Live metrics** — sent, responded, converted and ROI are recomputed as engagement and attribution happen, so an in-flight campaign's numbers are real numbers you can act on today.
