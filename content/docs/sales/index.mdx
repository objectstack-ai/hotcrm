...
| [**Activities**](/docs/sales/activities) | Calls, emails, meetings and tasks scheduled on any record. |
...
The [Sales Copilot](/docs/ai-copilot/sales-copilot) is built in. When you open a lead, account or opportunity, it can:
