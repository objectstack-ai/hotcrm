...
```typescript
import { aiSmartBriefing } from '@hotcrm/actions';

const briefing = await aiSmartBriefing({
  accountId: accountId
});
...
- Open an issue on [GitHub](https://github.com/hotcrm/hotcrm/issues) for support
