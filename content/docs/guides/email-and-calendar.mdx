...
On any record, click **✍️ Draft Email** to have the [Sales Copilot](/docs/ai-copilot/sales-copilot) or [Service Copilot](/docs/ai-copilot/service-copilot) draft a contextual email:
