...
**Key Objects**: `Case`, `CaseComment`, `KnowledgeArticle`, `Queue`, `QueueMember`, `RoutingRule`, `Skill`, `AgentSkill`, `SLAPolicy`, `SLATemplate`, `SLAMilestone`, `BusinessHours`, `Holiday`, `HolidayCalendar`, `EscalationRule`, `WebToCase`, `EmailToCase`, `SocialMediaCase`, `ForumTopic`, `ForumPost`, `PortalUser`
