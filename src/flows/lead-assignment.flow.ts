  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        ...
        severity: 'warning',
        topic: 'lead_routing',
        title: 'Hot lead — assign within 24h: {record.full_name}',
        body: '{record.full_name} from {record.company} (rating {record.rating}) needs an owner today.',
    ...
    },
    {
      ...
      config: {
        ...
        body: '{record.full_name} from {record.company} is awaiting assignment.',
        actionUrl: '/crm_lead/{record.id}',
      },
    },
