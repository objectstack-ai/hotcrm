  ...
  navigation: [
    {
      ...
      children: [
        ...
        { id: 'nav_contract', type: 'object', objectName: 'crm_contract', label: 'Contracts', icon: 'file-pen-line' },
        // Business-prominence shortcut: power users open the Kanban directly.
        { id: 'nav_pipeline', type: 'object', objectName: 'crm_opportunity', viewName: 'pipeline_kanban', label: 'Sales Pipeline', icon: 'columns-3' },
        { id: 'nav_forecast', type: 'object', objectName: 'crm_forecast', label: 'Forecast', icon: 'trending-up' },
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'nav_task', type: 'object', objectName: 'crm_task', label: 'Tasks', icon: 'list-checks' },
        // Business-prominence shortcut: support managers open the workflow board directly.
        { id: 'nav_case_board', type: 'object', objectName: 'crm_case', viewName: 'case_workflow', label: 'Service Board', icon: 'columns-3' },
    ...
    },
    {
      ...
      icon: 'box',
      children: [
        { id: 'nav_product', type: 'object', objectName: 'crm_product', label: 'Products', icon: 'box-open' },
      ],
    },
    {
      id: 'group_analytics',
