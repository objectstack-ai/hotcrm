...
The SLA (Service-Level Agreement) system stamps a **deadline** on every case, flags **breaches** on an hourly sweep, and **escalates** stuck cases automatically — escalation flags the case and alerts its owner; it does not move the case to senior staff.
