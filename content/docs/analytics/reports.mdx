...
The five other reports this section used to list are published nowhere, and most of them ask the semantic layer for something it does not carry. `case_metrics` (`src/datasets/case.dataset.ts`) reads `crm_case` alone, through six dimensions — **Status**, **Priority**, **Origin**, **Type**, **Created** (bucketed by day), **Resolving Article** — and eight measures: **Cases**, **Avg Resolution (h)**, **SLA Violation Rate**, **Closed Cases**, **Resolved by KB**, **KB Deflection Rate**, **Cases Within SLA** and **SLA Compliance Rate**.
