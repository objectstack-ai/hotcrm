...
Skills are deterministic when you mock the LLM. The example tests a hypothetical `renewal-pitch` skill (the shipped skills live in `src/sales/skills/` and `src/service/skills/`):
