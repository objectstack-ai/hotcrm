...
description: Understanding HotCRM's plugin-based architecture for modular business packages
---
...
**Core CRM functionality** - Accounts, Contacts, Leads, Opportunities, and Activities
...
### 2. Marketing Plugin (@hotcrm/marketing)

**Marketing automation** - Campaigns, Email Templates, Landing Pages, Forms, and List Segmentation

**Dependencies**: `crm` (required for Lead and Contact references)

**Objects** (7):
- Campaign, Campaign Member
- Email Template, Landing Page, Form
- Marketing List, Unsubscribe

**Location**: `packages/marketing/src/plugin.ts`

### 3. Products Plugin (@hotcrm/products)
...
import { MarketingPlugin } from '@hotcrm/marketing/dist/plugin.js';
...
✓ All business plugins loaded (43 total objects)

✅ HotCRM server is running!
   ObjectStack v0.7.2 (Plugin Architecture)
   5 business plugins loaded
   43 objects available
```
