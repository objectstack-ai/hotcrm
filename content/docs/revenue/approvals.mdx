...
- **Amount $100K or more** → **Sales Manager** review.
...
| --- | --- | --- | --- |
| **1. Sales Manager** | The `sales_manager` role | Amount $100K or more | First line of defense — sanity-check the deal |
...
| Tab | What it shows |
| --- | --- |
| **My Pending** | Requests waiting on your decision, with a count badge |
| **Submitted by me** | Requests you raised, in any state |
| **All** | Every request you are allowed to see |
...
| Built-in view on the object | What it shows |
| --- | --- |
...
| Built-in view on the object | Approval centre tab |
| --- | --- |
| **My Pending** | **My Pending** — same words, different screen |
| **I Submitted** | **Submitted by me** |
| **Completed** | *no tab* — use the **Status** filter instead |
| **All** | **All** — same words, different screen |
