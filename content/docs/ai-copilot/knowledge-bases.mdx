...
| --- | --- | --- |
| 📘 **Sales Knowledge** | Sales skills | Playbooks, objection handling, qualification frameworks, win/loss notes |
| 📗 **Product Information** | Sales + Service | Product datasheets, feature specs, release notes, FAQs |
| 🎧 **Support Knowledge** | Service skills | KB articles, troubleshooting guides, runbooks |
...
Everything about what you sell. Read by both the sales and the service skills.
