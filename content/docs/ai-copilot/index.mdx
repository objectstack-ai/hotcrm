...
products, knowledge articles, and process rules.
...
2. **Knowledge articles** — one library of support articles, filed by category, that the assistant queries like any other object. There is no separate product, sales or competitive library. See [Knowledge Bases](/docs/ai-copilot/knowledge-bases).
