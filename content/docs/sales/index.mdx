...
The **HotCRM app** sidebar groups everything under **Sales**, and that group carries nine entries — six object entries plus three that open something other than an object list:
