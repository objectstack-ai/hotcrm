...
export const CaseEscalationFlow = {
  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        rules: [
          { label: 'Level 1 — Warn', condition: 'hours_open > 4 && hours_open <= 8' },
          { label: 'Level 2 — Escalate', condition: 'hours_open > 8 && hours_open <= 24' },
          { label: 'Level 3 — Executive', condition: 'hours_open > 24' },
          { label: 'Within SLA', condition: 'hours_open <= 4' },
        ],
      },
      position: { x: 0, y: 100 },
    },
  ...
  edges: [
    ...
    { id: 'e2', source: 'check_sla', target: 'end', type: 'default' as const, condition: 'hours_open <= 4', label: 'Within SLA' },
    { id: 'e3', source: 'check_sla', target: 'notify_manager', type: 'default' as const, condition: 'hours_open > 4 && hours_open <= 8', label: 'Level 1' },
    { id: 'e4', source: 'check_sla', target: 'reassign_case', type: 'default' as const, condition: 'hours_open > 8 && hours_open <= 24', label: 'Level 2' },
    { id: 'e5', source: 'check_sla', target: 'exec_alert', type: 'default' as const, condition: 'hours_open > 24', label: 'Level 3' },
