...
| --- | --- |
| **Email Opt Out** | **Enforced.** The **Send Email** action is hidden on a contact who has opted out — on the record header and on the list row — and the automatic welcome email is skipped when such a contact is created. |
