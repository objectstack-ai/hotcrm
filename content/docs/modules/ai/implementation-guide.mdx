...
description: Comprehensive guide to AI/ML infrastructure implementation for HotCRM, covering ML providers, model registry, prediction services, caching, monitoring, and explainability.
---
...
See the [AI Package Documentation](/docs/modules/ai) for complete API reference.
