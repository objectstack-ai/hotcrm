  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        ...
        template: 'crm.lead_conversion_approved',
        templateData: { first_name: '{leadRecord.first_name}', last_name: '{leadRecord.last_name}' },
    ...
    },
    {
      ...
      config: {
        ...
        template: 'crm.lead_conversion_rejected',
        templateData: { first_name: '{leadRecord.first_name}', last_name: '{leadRecord.last_name}' },
        actionUrl: '/crm_lead/{record.id}',
      },
    },
