...
|-------|---------|---------|------------|
| Sales Cloud | `@hotcrm/crm` | 13 | Account, Contact, Lead, Opportunity, marketing automation |
| Marketing Cloud | `@hotcrm/marketing` | 2 | Campaign management, campaign member tracking |
