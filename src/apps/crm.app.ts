  ...
  navigation: [
    {
      ...
      children: [
        ...
        { id: 'nav_forecast', type: 'object', objectName: 'forecast', label: 'Forecast', icon: 'trending-up' },
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'nav_knowledge', type: 'object', objectName: 'knowledge_article', label: 'Knowledge', icon: 'book-open' },
