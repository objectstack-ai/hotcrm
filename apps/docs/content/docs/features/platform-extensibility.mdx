...
<Cards>
  <Card title="Core Package Docs" href="/docs/packages/core" />
  <Card title="AI Package Docs" href="/docs/packages/ai" />
  <Card title="Server Package Docs" href="/docs/packages/server" />
</Cards>
