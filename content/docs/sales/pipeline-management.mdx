...
- Add or remove stages? You need to update three places: the picklist on the opportunity object, the workflow rule that sets probabilities, and the state machine that controls transitions. See [Customization › Extending Objects](/docs/customization/extending-objects).
