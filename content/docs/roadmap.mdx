...
> **Protocol Version**: @objectstack/spec v3.0.8 | **Tests**: 3,707 passing (188 files) | **Spec Schema Adoption**: ~95 / ~95 (~100%) | **Last Updated**: February 21, 2027
...
| Seed Data Files | 39 across 13 packages |
| Test Files | 188 files, 3,707 tests (all passing) |
...
| **Total** | **~148** | **121+** | **49** | **59** | **34** | **15** | **33** | **188 files / 3,707 tests** |
