...
- The SLA target per priority is set via the case object's automation (a SLA-calculation hook). To adjust, edit `src/objects/case.hook.ts` or change the underlying configuration — see [Administration › Automation](/docs/administration/automation).
