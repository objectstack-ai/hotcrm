...
Products saves **two** views (`src/revenue/views/product.view.ts`), and the two tabs above the list — one per view, each labelled with the view's own name — switch between them:
