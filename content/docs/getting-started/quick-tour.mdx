...
4. Click **🎯 Qualify** on the lead detail page — the [Sales Copilot](/docs/ai-copilot/sales-copilot) will score them as Hot / Warm / Cold and suggest the next action.
...
3. Click **🚦 Triage** on a new case — the [Service Copilot](/docs/ai-copilot/service-copilot) suggests priority, category, and the top 3 matching knowledge-base articles.
