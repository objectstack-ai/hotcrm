...
export const SlaWidget = {
  ...
  properties: [
    ...
    { name: 'periodDays', label: 'Period (days)', type: 'number' as const, required: false, default: 30, description: 'Rolling period for compliance calculation' },
    { name: 'targetPercent', label: 'Target %', type: 'number' as const, required: false, default: 95, description: 'SLA compliance target percentage' },
    { name: 'showBreakdown', label: 'Show Breakdown', type: 'boolean' as const, required: false, default: true, description: 'Display detailed met/breached/at-risk breakdown' }
  ]
