...
export const ReportSeedData = [
  ...
  { name: 'Quarterly Revenue Summary', description: 'Summary report aggregating closed-won revenue by quarter and sales region.', type: 'summary', object_name: 'opportunity', columns: ['name', 'amount', 'close_date', 'region', 'owner'], filters: [{ field: 'stage', operator: '=', value: 'closed_won' }, { field: 'close_date', operator: '>=', value: '2025-01-01' }], sort_by: 'amount', group_by: 'region', created_by: 'james.wilson@hotcrm.example.com' },
