...
> `package.json` has pinned since 2026-09-01. Every claim those two sources can answer was
> re-taken rather than carried forward, and three did not survive the re-check: they are
> corrected below, not re-dated around. What a re-measurement here cannot reach is the
