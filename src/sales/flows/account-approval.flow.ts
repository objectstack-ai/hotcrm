  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        ...
        title: 'Account approved: {accountRecord.name}',
        message: 'This account has been signed off and is now established data.',
    ...
    },
    {
      ...
      config: {
        ...
        title: 'Account not approved: {accountRecord.name}',
        message: 'This account was not signed off. Correct its details and ask for another review.',
        actionUrl: '/crm_account/{record.id}',
      },
    },
