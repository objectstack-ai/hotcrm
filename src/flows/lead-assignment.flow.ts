  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        ...
        severity: 'warning',
        topic: 'lead_routing',
        template: 'crm_lead_hot',
        templateData: { first_name: '{record.first_name}', last_name: '{record.last_name}', company: '{record.company}', rating: '{record.rating}' },
    ...
    },
    {
      ...
      config: {
        ...
        channels: ['inbox'],
        topic: 'lead_routing',
        template: 'crm_lead_new',
        templateData: { first_name: '{record.first_name}', last_name: '{record.last_name}', company: '{record.company}' },
        actionUrl: '/crm_lead/{record.id}',
      },
    },
