...
Inside HotCRM, the left nav opens with one pinned item — **Home**, which is the **Executive Overview** dashboard — and everything else sits in six groups:
...
**Marketing** and **Insights** are collapsed when the app loads — only **Sales**, **My Work**, **Activity** and **Service** open themselves. Click a group open before deciding something isn't there.
...
- Four item names this page used to list have left the sidebar without leaving the product — each is now a tab on the list page it belongs to. *Pipeline* is the pipeline tab on **Opportunities**; *Calendar* and *Interaction History* are tabs on **Events**; *All Tasks* is the first tab on the page **My Tasks** opens.
