...
describe('CaseEntitlementCheck', () => {
 ...
 priority: 'critical'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
 ...
 priority: 'low'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
 ...
 const caseDoc = {
 account: 'acc_missing',
 subject: 'Orphan case'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
 ...
 const caseDoc = {
 account: 'acc_null',
 subject: 'Null result case'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
 ...
 const caseDoc = {
 account: 'acc_err',
 subject: 'Error case'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
 ...
 const caseDoc = {
 account: 'acc_iso',
 subject: 'ISO date test'} as Record<string, any>;
 const ctx = { 
 input: { doc: caseDoc },
 ql: mockQl
 };
