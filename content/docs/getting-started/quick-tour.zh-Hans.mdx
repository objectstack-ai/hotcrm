...
在 HotCRM 内，左侧导航最上面是一个固定条目——**Home**，它打开的是 **Executive Overview** 仪表盘；其余内容分在 6 个分组里：
...
**Marketing**、**Insights** 这两个分组在应用加载时是折叠的——只有 **Sales**、**My Work**、**Activity**、**Service** 会自动展开。先把分组点开，再判断某样东西在不在这里。
...
- 本页过去列出的 4 个条目名已经不在侧边栏了，但功能一个都没少——它们各自成了所属列表页上的一个标签页：*Pipeline* 是 **Opportunities** 页面上的管道标签页；*Calendar* 与 *Interaction History* 是 **Events** 页面上的标签页；*All Tasks* 则是 **My Tasks** 打开的那个页面的第一个标签页。
