...
export default defineSkill({
  ...
  input: {
    contract_id: { type: 'reference', object: 'contract', required: true },
  ...
  data_sources: {
    contract:      { object: 'contract',     by: 'id' },
    account:       { object: 'account',      by: 'contract.account' },
    primary_contact: { object: 'contact',    by: 'contract.account.primary_contact' },
